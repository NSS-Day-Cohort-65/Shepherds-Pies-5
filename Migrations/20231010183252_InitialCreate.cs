    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PizzaCheeses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PizzaSauces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pizzas_PizzaCheeses_PizzaCheeseId",
                        column: x => x.PizzaCheeseId,
                        principalTable: "PizzaCheeses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pizzas_PizzaSauces_PizzaSauceId",
                        column: x => x.PizzaSauceId,
                        principalTable: "PizzaSauces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "c3aaeb97-d2ba-4a53-a521-4eea61e59b35", "d6238e5b-95d8-4ef1-af05-14cb42911239", "Admin", "admin" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", 0, "53277677-566c-4863-97f8-19913a125278", "admina@strator.comx", false, false, null, null, null, "AQAAAAEAACcQAAAAEAc821ZYcLtkKakStVMliAu1OKJZhE1KaZcud2UxXMz/BpOA5XBvCorQ2Gm0gu3lFg==", null, false, "50d5eb85-2213-4c24-9384-6bc3d2c6cae0", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 0.50m, "Mushroom" },
                    { 4, 0.50m, "Onion" },
                    { 5, 0.50m, "Green Pepper" },
                    { 6, 0.50m, "Black Olive" },
                    { 7, 0.50m, "Basil" },
                    { 8, 0.50m, "Extra Cheese" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "DriverId", "EmployeeId", "OrderDate", "TableNumber", "Tip" },
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(2023, 10, 10, 14, 32, 52, 260, DateTimeKind.Local).AddTicks(1994), null, null },
                    { 2, null, 1, new DateTime(2023, 10, 10, 14, 32, 52, 260, DateTimeKind.Local).AddTicks(2020), 1, null }
                });

            migrationBuilder.InsertData(
                table: "Pizzas",
                columns: new[] { "Id", "OrderId", "PizzaCheeseId", "PizzaSauceId", "PizzaSizeId" },
                values: new object[,]
                {
                    { 1, 1, 1, 1, 1 },
                    { 2, 2, 3, 4, 2 },
